...
cloudinary.config({ 
    cloud_name: 'dhtlpslop', 
    api_key: '916956426517129', 
    api_secret: 'lIEcFmAyRGIHFl-9fOsIWzrPz1o' 
  });
...
const uploadMusic = async (req, res) => {
    try {
        ...
        if (!files || !files['file'] || !files['coverImage'] || !title || !artist || !genre || !description)  {
...
const updateMusic = async (req, res) => {
    ...
    try {
        ...
        if ( req.body?.description) music.description = req.body.description; 
